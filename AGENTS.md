...
Delete this paragraph when the carve-out goes, along with the rule itself, the
guard and its specs, and the note above the first `//nolint:gosec` directive in
