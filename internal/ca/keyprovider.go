...
// applying at-rest encryption when EncryptCAKey is set. Mirrors bootstrapCA's
// handling so a key created by the CSR path is indistinguishable from one
// created by a normal bootstrap.
